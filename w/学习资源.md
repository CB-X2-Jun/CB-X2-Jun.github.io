# 学习资源
#### 注：本网页转载自 [https://oiwiki.org/contest/resources/](https://oiwiki.org/contest/resources/)，此后略有改动。
...
-   [BZOJ](https://www.lydsy.com/JudgeOnline/) ：因原属衡阳八中而得此简称，汇聚多种习题和真题，题目质量相对较高，但可能需要联系邮箱。BZOJ 上有大量只有付费用户才能提交的题目。2018 年 BZOJ 测试数据泄露，催生了 [DarkBZOJ](https://darkbzoj.cc/)（黑暗爆炸 OJ）。
...
-   [QOJ](https://qoj.ac/)
-   [Universal Online Judge](https://uoj.ac/)：始于 2014 年，Universal 取通用之意，[项目开源](https://github.com/UniversalOJ/UOJ-System)；[VFK](https://github.com/vfleaking) 的 OJ：多原创比赛题和 CCF/THU 题，难度较高。可以在 [UOJ 部署指北](https://universaloj.github.io/) 中找到在自己的电脑上搭建 UOJ 的方法。
-   [Vijos](https://vijos.org/)：始于 2005 年。[服务端](https://github.com/vijos/vj4) 和 [评测机](https://github.com/vijos/jd4) 等项目开源。
-   [Virtual Judge](https://vjudge.net)：可以提交多个 OJ 的题目，还有翻译功能。
-   [WZOI](https://wzoi.cc)：始于 2017 年，由浙江省温州中学维护的 [开源](https://github.com/massimodong/wzoj) 评测系统。
-   [ZOJ](https://zoj.pintia.cn/home)：浙江大学在线评测系统，始于 2001 年。现在题目集已经转至 PTA。
